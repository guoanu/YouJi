...
import { createNote, getErrorMessage, getNote, listNotesByKind, updateNote } from "../features/notes/api";
...
export function NotePad({
  ...
  const refreshNotes = useCallback(async () => {
    ...
    const loadedNotes = await listNotesByKind("freeNote");
  ...
  const saveNote = useCallback(async () => {
    ...
    const request = { title, content, category: existingCategory, kind: "freeNote" as const };
